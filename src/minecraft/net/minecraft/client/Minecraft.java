    ...
    implements Runnable
{
    ...
    public static void startMainThread(String s, String s1, String s2)
    {
        boolean flag = false;
        String s3 = s;
        Frame frame = new Frame(Estomonia.instance.name + " - For the Betalands Community.");
    ...
    public static void main(String args[])
    {
        String s = null;
        String s1 = null;
        s = (new StringBuilder()).append("NamedDeveloper").toString();
        if(args.length > 0)
        {
            s = args[0];
        }
