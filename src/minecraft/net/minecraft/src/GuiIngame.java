...
import net.minecraft.src.estomonia.gui.GuiRendering;
	...
	public void renderGameOverlay(float f, boolean flag, int i, int j) {
		...
		if (mc.gameSettings.showDebugInfo) {
			...
			fontrenderer.drawStringWithShadow(
					(new StringBuilder()).append("Minecraft Beta 1.7.3 (").append(mc.debug).append(")").toString(), 2,
					2, 0xffffff);
