...
import net.minecraft.src.estomonia.gui.other.EstomoniaGui;
...
public class GuiOptions extends GuiScreen {
	...
	public void initGui() {
		...
		controlList.add(new GuiButton(500, width / 2 - 100, height / 6 + 100 - 20, Estomonia.instance.name));
	}
	...
	protected void actionPerformed(GuiButton guibutton) {
		...
		if (guibutton.id == 500) {
			mc.displayGuiScreen(new EstomoniaGui(this));
		}
	}
